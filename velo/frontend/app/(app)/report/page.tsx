      ...
      <div className="mb-8 flex flex-wrap items-start gap-4 justify-between">
        ...
        {report && (
          <button
            ...
            className="flex items-center gap-1.5 font-body text-xs border border-slate-200 px-3.5 py-2 rounded-xl text-slate-500 hover:bg-slate-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >

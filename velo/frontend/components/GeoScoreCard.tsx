  ...
  return (
    <div className="bg-white border border-slate-200/80 rounded-3xl p-6 shadow-[0_1px_2px_rgba(15,25,35,0.04),0_16px_40px_-20px_rgba(15,25,35,0.12)]">
      <div className="flex items-start justify-between mb-4">
        <p className="font-body text-[10px] font-semibold text-slate-400 uppercase tracking-widest capitalize">
          {engine}
        </p>
        {diff !== null && (
          <span className={`font-body text-xs font-semibold px-2.5 py-1 rounded-full border ${diffColor} ${diffBg}`}>
      ...
      <div className="group relative mt-2 inline-flex items-center gap-1.5">
        <p className="font-body text-xs text-slate-400">GEO Score / 100</p>
        <Info size={12} className="text-slate-300 group-hover:text-slate-500 transition-colors cursor-help" />
        <div
          role="tooltip"
          className="pointer-events-none absolute bottom-full left-0 mb-2 w-60 rounded-2xl bg-slate-900 text-slate-200 font-body text-[11px] leading-[1.6] px-4 py-3 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all shadow-xl z-20"
        >
